  ...
  const handleSelection = (selection) => {
    ...
    setTimeout(() => {
      ...
      setTimeout(() => {
        ...
        setResult(
          yourWinner ? "You win!" : computerWinner ? "You lose!" : "Draw!"
        );
        setScore(newScore);
      }, 1000);
    }, 500);
  ...
  return (
    <div className="page-content">
      <div className="scoreboard-nav">
        ...
        <div className="result fs-200 text-neutral-200 fw-semi-bold">
          SCORE
          <div
            className="result-score fs-700 fw-bold text-neutral-100"
            data-score
          >
            {score}
          </div>
        ...
        <div className="container">
          ...
          <div className="game-container">
            <div className="container-btn-1">
              <div className="div-btn-choose choose-paper bg-primary-200">
                <button
                  className="btn-choose"
                  data-selection="paper"
                  onClick={() => {
                    toggleGameVisibility();
                    handleSelection(SELECTIONS[0]);
                  }}
                >
                  <svg
              ...
              <div className="div-btn-choose choose-scissors bg-primary-100">
                <button
                  className="btn-choose"
                  data-selection="scissors"
                  onClick={() => {
                    toggleGameVisibility();
                    handleSelection(SELECTIONS[1]);
                  }}
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
            ...
            <div className="container-btn-2">
              <div className="div-btn-choose choose-rock bg-primary-300">
                <button
                  className="btn-choose"
                  data-selection="rock"
                  onClick={() => {
                    toggleGameVisibility();
                    handleSelection(SELECTIONS[2]);
                  }}
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
        ...
        <div className="container-results">
          ...
          {result && (
            <div className="input-win">
              <div className="fw-bold fs-600">{result}</div>
              <button
                className="btn-restart fs-200 fw-semi-bold text-neutral-100"
                onClick={resetGame}
              >
                PLAY AGAIN
              </button>
